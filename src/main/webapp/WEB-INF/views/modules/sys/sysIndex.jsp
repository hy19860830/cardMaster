	...
	<div id="main">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li style= "display:none"><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>
					</li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2013-2015 ${fns:getConfig('productName')} 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
