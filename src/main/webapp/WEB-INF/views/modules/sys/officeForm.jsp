...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div  class="control-group">
			...
			<div class="controls">
				<form:input path="master" htmlEscape="false" maxlength="50" value=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="homepage" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">后台密码:</label>
			<div class="controls">
				<form:input path="staffuserpassword" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">公司名片夹:</label>
			<div class="controls">
				<form:select path="companypower" class="input-medium">
					<form:options items="${fns:getDictList('sys_office_power')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="simpleinfo" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">业务介绍:</label>
			<div class="controls">
				<form:textarea path="businessinfo" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge"/>
			</div>
		</div>
		<!--快速添加下级部门 功能暂时屏蔽-->
