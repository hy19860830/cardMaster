				...
				<tr>
					...
					<td>
						...
						<c:if test="${not empty task.assignee}"><%--
							...
							<a href="${ctx}/act/task/form?taskId=${task.id}&taskName=1${fns:urlEncode(task.name)}&taskDefKey=${task.taskDefinitionKey}&procInsId=${task.processInstanceId}&procDefId=${task.processDefinitionId}&status=${status}">任务办理</a>
						</c:if>
